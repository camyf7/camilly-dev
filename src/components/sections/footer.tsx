...
const socialLinks = [
  ...
  {
    name: 'Email',
    href: 'mailto:camillyf691@gmail.com',
    icon: (
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          >
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-primary/10 transition-all"
        ...
        >
          <p className="text-xs text-muted-foreground">
            ...
            <span className="text-foreground">GSAP</span>
          </p>
        </motion.div>
      </div>
    </footer>
